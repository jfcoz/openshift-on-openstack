...
parameters:
   ...
   # Set Operating System volume size
   master_os_volume_size_gb: 25
   infra_os_volume_size_gb: 25
   node_os_volume_size_gb: 25
   bastion_os_volume_size_gb: 25
   lb_os_volume_size_gb: 25
